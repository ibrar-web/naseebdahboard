...
const ShieldIcon = ({ className }: IconProps) => (
  <svg className={className} aria-hidden="true" viewBox="0 0 24 24" fill="none">
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M9.4 12.2 11 13.8l3.6-3.8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
  </svg>
);
...
const ChartIcon = ({ className }: IconProps) => (
  <svg className={className} aria-hidden="true" viewBox="0 0 24 24" fill="none">
    <path d="M5 19V8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    <path d="M12 19V5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    <path d="M19 19v-8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      ...
      <aside className="relative hidden min-h-screen overflow-hidden bg-primary text-white lg:block">
        ...
        <div className="relative z-10 flex min-h-screen flex-col px-[8%] py-7">
          <div className="flex items-center gap-5">
            <img src={logoSrc} alt="Naseeb" className="h-[70px] w-[70px] object-cover" />
            <div>
              <p className="text-[34px] font-extrabold leading-none tracking-[-0.01em] text-white">Naseeb</p>
              <p className="mt-2 text-sm font-bold uppercase tracking-[0.32em] text-white/55">Admin Portal</p>
            </div>
          </div>
          ...
          <div className="flex flex-1 flex-col justify-end">
            <section className="mb-[15vh] max-w-[480px]">
              ...
              <p className="mt-7 max-w-[420px] text-[19px] font-medium leading-9 text-white/68">
                A centralised platform for Naseeb's team to oversee listings, deals, payments, and traders - all in one
                place.
              </p>
            </section>
            ...
            <div className="mb-3 flex flex-wrap gap-4">
              {accessBadges.map(({ label, Icon }) => (
                <div
                  key={label}
                  className="inline-flex h-10 items-center gap-2 rounded-full bg-white/13 px-5 text-sm font-bold text-white/82"
                >
      ...
      <main className="flex min-h-screen items-center justify-center px-5 py-10 sm:px-8 lg:px-16">
        <section className="w-full max-w-[542px]">
          <div className="mb-10 flex items-center gap-4 lg:hidden">
            <img src={logoSrc} alt="Naseeb" className="h-14 w-14 object-cover" />
            <div>
              <p className="text-3xl font-extrabold leading-none text-ink">Naseeb</p>
              <p className="mt-1 text-xs font-bold uppercase tracking-[0.28em] text-muted">Admin Portal</p>
            </div>
          </div>

          <div>
            <h2 className="text-[40px] font-extrabold leading-tight tracking-[-0.01em] text-ink">Sign in</h2>
            <p className="mt-2 text-lg font-medium text-muted">Enter your credentials to access the admin portal</p>
          </div>
          ...
          <form className="mt-12 space-y-7" onSubmit={handleSubmit(onSubmit)}>
            <label className="block">
              ...
              {errors.email ? <p className="mt-2 text-sm font-medium text-red-700">{errors.email.message}</p> : null}
            </label>
            ...
            <label className="block">
              ...
              {errors.password ? (
                <p className="mt-2 text-sm font-medium text-red-700">{errors.password.message}</p>
              ) : null}
            </label>
          ...
          <div className="mt-10 flex items-center gap-4 rounded-[14px] bg-white px-6 py-5 shadow-[0_18px_50px_rgba(20,24,38,0.05)]">
            ...
            <div className="min-w-0">
              <p className="text-base font-extrabold text-muted">Demo Credentials</p>
              <p className="mt-1 break-words font-mono text-sm font-bold tracking-[0.04em] text-muted">
                admin@naseeb.pk <span className="mx-3 text-slate-400">.</span> password
              </p>
            </div>
          </div>
